...
namespace SnowflakeApp
{
    ...
    public class Snowflake
    {
        ...
        private static long twepoch = 687888001020L; //唯一时间随机量   1288834974657L  2000年

        private static long machineIdBits = 5L; //工作机器码字节数
        private static long datacenterIdBits = 5L;//数据中心字节数
        ...
        private static long timestampLeftShift = sequenceBits + machineIdBits + datacenterIdBits; //时间戳左移动位数就是机器码+计数器总字节数+数据中心字节数
